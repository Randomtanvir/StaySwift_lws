    ...
    <>
      ...
      <button
        ...
        className={`${
          allowSearch
            ? "search-btn"
            : "bg-gray-600 px-8 py-3 rounded-md block mx-auto text-white font-bold -translate-y-1/2 cursor-not-allowed hover:shadow-primary/50 active:scale-95 transition-all"
        }`}
        onClick={doSearch}
      >
